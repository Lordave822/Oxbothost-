...
<!--
  ...
  Replace href="login.php" everywhere with your order / billing link.
...
<header class="nav">
  ...
  <div class="wrap nav-row">
    ...
    <div class="navr">
      ...
      <a class="btn sm" href="login.php">Get started</a>
  ...
  <div class="mobile-menu"><div class="wrap">
    <a href="#pricing">Products</a><a href="#domains">Domains</a><a href="#features">Why oxbothost</a><a href="#faq">FAQ</a><a href="login.php">Log in</a>
...
<section id="domains" class="band">
  <div class="wrap band-grid">
    ...
    <div>
      ...
      <div class="dom-list"><div class="dom-row"><div class="dom-name"><span class="nm">yourbrand</span><span>.com</span></div><div class="dom-price">$11.99/yr</div><a class="btn sm ghost" href="login.php">Register</a></div><div class="dom-row"><div class="dom-name"><span class="nm">yourbrand</span><span>.net</span></div><div class="dom-price">$13.99/yr</div><a class="btn sm ghost" href="login.php">Register</a></div><div class="dom-row"><div class="dom-name"><span class="nm">yourbrand</span><span>.org</span></div><div class="dom-price">$12.99/yr</div><a class="btn sm ghost" href="login.php">Register</a></div><div class="dom-row"><div class="dom-name"><span class="nm">yourbrand</span><span>.xyz</span></div><div class="dom-price">$2.99/yr</div><a class="btn sm ghost" href="login.php">Register</a></div><div class="dom-row"><div class="dom-name"><span class="nm">yourbrand</span><span>.dev</span></div><div class="dom-price">$14.99/yr</div><a class="btn sm ghost" href="login.php">Register</a></div><div class="dom-row"><div class="dom-name"><span class="nm">yourbrand</span><span>.co</span></div><div class="dom-price">$24.99/yr</div><a class="btn sm ghost" href="login.php">Register</a></div></div>
...
<section id="pricing" class="inv pricing">
  <div class="wrap">
    ...
    <div class="panels">
<div class="panel p-vps"><p class="panel-copy">Full root access on NVMe storage. Pick a Linux image, log in, and build.</p><div class="plans"><div class="plan"><div class="plan-top"><h3>Starter</h3></div><div><div class="py"><span class="amt">$4</span><span class="per">/mo</span><div class="billed">billed $48 yearly</div></div><div class="pm"><span class="amt">$5</span><span class="per">/mo</span><div class="billed">billed monthly</div></div></div><ul class="specs"><li><span>CPU</span><b>1 vCPU</b></li><li><span>Memory</span><b>1 GB</b></li><li><span>Storage</span><b>20 GB NVMe</b></li><li><span>Transfer</span><b>1 TB</b></li></ul><a class="btn ghost" href="login.php">Choose Starter</a></div><div class="plan"><div class="plan-top"><h3>Plus</h3></div><div><div class="py"><span class="amt">$8</span><span class="per">/mo</span><div class="billed">billed $96 yearly</div></div><div class="pm"><span class="amt">$10</span><span class="per">/mo</span><div class="billed">billed monthly</div></div></div><ul class="specs"><li><span>CPU</span><b>2 vCPU</b></li><li><span>Memory</span><b>4 GB</b></li><li><span>Storage</span><b>60 GB NVMe</b></li><li><span>Transfer</span><b>3 TB</b></li></ul><a class="btn ghost" href="login.php">Choose Plus</a></div><div class="plan feat"><div class="plan-top"><h3>Pro</h3><span class="badge">Most popular</span></div><div><div class="py"><span class="amt">$16</span><span class="per">/mo</span><div class="billed">billed $192 yearly</div></div><div class="pm"><span class="amt">$20</span><span class="per">/mo</span><div class="billed">billed monthly</div></div></div><ul class="specs"><li><span>CPU</span><b>4 vCPU</b></li><li><span>Memory</span><b>8 GB</b></li><li><span>Storage</span><b>120 GB NVMe</b></li><li><span>Transfer</span><b>5 TB</b></li></ul><a class="btn" href="login.php">Choose Pro</a></div><div class="plan"><div class="plan-top"><h3>Max</h3></div><div><div class="py"><span class="amt">$32</span><span class="per">/mo</span><div class="billed">billed $384 yearly</div></div><div class="pm"><span class="amt">$40</span><span class="per">/mo</span><div class="billed">billed monthly</div></div></div><ul class="specs"><li><span>CPU</span><b>8 vCPU</b></li><li><span>Memory</span><b>16 GB</b></li><li><span>Storage</span><b>240 GB NVMe</b></li><li><span>Transfer</span><b>8 TB</b></li></ul><a class="btn ghost" href="login.php">Choose Max</a></div></div><p class="swipe">Swipe to see more plans</p></div>
<div class="panel p-hosting"><p class="panel-copy">Managed hosting for websites and stores, with free SSL and one-click WordPress.</p><div class="plans"><div class="plan"><div class="plan-top"><h3>Single</h3></div><div><div class="py"><span class="amt">$2</span><span class="per">/mo</span><div class="billed">billed $24 yearly</div></div><div class="pm"><span class="amt">$3</span><span class="per">/mo</span><div class="billed">billed monthly</div></div></div><ul class="specs"><li><span>Websites</span><b>1</b></li><li><span>Storage</span><b>10 GB NVMe</b></li><li><span>Email</span><b>1 account</b></li><li><span>SSL</span><b>Free</b></li></ul><a class="btn ghost" href="login.php">Choose Single</a></div><div class="plan feat"><div class="plan-top"><h3>Premium</h3><span class="badge">Most popular</span></div><div><div class="py"><span class="amt">$5</span><span class="per">/mo</span><div class="billed">billed $60 yearly</div></div><div class="pm"><span class="amt">$7</span><span class="per">/mo</span><div class="billed">billed monthly</div></div></div><ul class="specs"><li><span>Websites</span><b>25</b></li><li><span>Storage</span><b>50 GB NVMe</b></li><li><span>Email</span><b>25 accounts</b></li><li><span>SSL</span><b>Free</b></li></ul><a class="btn" href="login.php">Choose Premium</a></div><div class="plan"><div class="plan-top"><h3>Business</h3></div><div><div class="py"><span class="amt">$9</span><span class="per">/mo</span><div class="billed">billed $108 yearly</div></div><div class="pm"><span class="amt">$12</span><span class="per">/mo</span><div class="billed">billed monthly</div></div></div><ul class="specs"><li><span>Websites</span><b>100</b></li><li><span>Storage</span><b>150 GB NVMe</b></li><li><span>Email</span><b>100 accounts</b></li><li><span>SSL</span><b>Free</b></li></ul><a class="btn ghost" href="login.php">Choose Business</a></div></div><p class="swipe">Swipe to see more plans</p></div>
<div class="panel p-domains"><p class="panel-copy">Register or transfer a domain and manage DNS from the same dashboard as your server.</p><div class="tlds"><div class="tld"><div class="tld-name">.com</div><div class="tld-price">$11.99/yr</div><a class="btn sm" href="login.php">Register</a></div><div class="tld"><div class="tld-name">.net</div><div class="tld-price">$13.99/yr</div><a class="btn sm" href="login.php">Register</a></div><div class="tld"><div class="tld-name">.org</div><div class="tld-price">$12.99/yr</div><a class="btn sm" href="login.php">Register</a></div><div class="tld"><div class="tld-name">.xyz</div><div class="tld-price">$2.99/yr</div><a class="btn sm" href="login.php">Register</a></div><div class="tld"><div class="tld-name">.dev</div><div class="tld-price">$14.99/yr</div><a class="btn sm" href="login.php">Register</a></div><div class="tld"><div class="tld-name">.co</div><div class="tld-price">$24.99/yr</div><a class="btn sm" href="login.php">Register</a></div><div class="tld"><div class="tld-name">.io</div><div class="tld-price">$39.99/yr</div><a class="btn sm" href="login.php">Register</a></div><div class="tld"><div class="tld-name">.app</div><div class="tld-price">$15.99/yr</div><a class="btn sm" href="login.php">Register</a></div></div></div>
<div class="panel p-servers"><p class="panel-copy">A whole machine, only yours. Built for databases, large apps and heavy traffic.</p><div class="plans"><div class="plan"><div class="plan-top"><h3>Core</h3></div><div><div><span class="amt">$59</span><span class="per">/mo</span><div class="billed">billed monthly</div></div></div><ul class="specs"><li><span>CPU</span><b>8 cores</b></li><li><span>Memory</span><b>32 GB</b></li><li><span>Storage</span><b>2 x 512 GB NVMe</b></li><li><span>Transfer</span><b>10 TB</b></li></ul><a class="btn ghost" href="login.php">Configure Core</a></div><div class="plan feat"><div class="plan-top"><h3>Power</h3><span class="badge">Most popular</span></div><div><div><span class="amt">$109</span><span class="per">/mo</span><div class="billed">billed monthly</div></div></div><ul class="specs"><li><span>CPU</span><b>16 cores</b></li><li><span>Memory</span><b>64 GB</b></li><li><span>Storage</span><b>2 x 1 TB NVMe</b></li><li><span>Transfer</span><b>20 TB</b></li></ul><a class="btn" href="login.php">Configure Power</a></div><div class="plan"><div class="plan-top"><h3>Elite</h3></div><div><div><span class="amt">$199</span><span class="per">/mo</span><div class="billed">billed monthly</div></div></div><ul class="specs"><li><span>CPU</span><b>32 cores</b></li><li><span>Memory</span><b>128 GB</b></li><li><span>Storage</span><b>2 x 2 TB NVMe</b></li><li><span>Transfer</span><b>50 TB</b></li></ul><a class="btn ghost" href="login.php">Configure Elite</a></div></div><p class="swipe">Swipe to see more plans</p></div>
    </div>
  </div>
</section>
