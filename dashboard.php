...
<div class="app">
  ...
  <aside class="rail inv" aria-label="Sidebar">
    <div class="rail-top">
      <a class="brand" href="index.php" aria-label="oxbothost home"><img class="brand-logo" src="assets/oxbothost-logo.svg" alt="oxbothost" width="30" height="30" loading="eager"><span><b>oxbothost</b></span></a>
