...
<!--
  ...
  of <body>
<?php $displayName = htmlspecialchars((string)$user["name"], ENT_QUOTES, "UTF-8"); ?>, so it works even with JavaScript off.

  ALL DATA HERE IS SAMPLE DATA (<?= $displayName ?>, adaobi.com, starter-01, 203.0.113.x, prices, dates).
...
<div class="app">
  ...
  <aside class="rail inv" aria-label="Sidebar">
    <div class="rail-top">
      <a class="brand" href="index.html" data-backend aria-label="oxbothost home"><img class="brand-logo" src="assets/oxbothost-logo.svg" alt="oxbothost" width="30" height="30" loading="eager"><span><b>oxbothost</b></span></a>
      ...
      <div class="actions">
        ...
        <details class="menu">
          ...
          <div class="pop">
            ...
            <a href="login.php" data-backend><svg class="ic" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M10 4H5v16h5"/><path d="M15 8l4 4-4 4M19 12H9"/></svg>Log out</a>
          </div>
        </details>
      </div>
    </header>
